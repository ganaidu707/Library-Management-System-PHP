    ...
    <div class="login_wrapper">
            ...
            <section class="login_content" style="margin-top: -40px;">
                <form name="form1" action="" method="post">
                    ...
                    <div>
                        <input type="text" class="form-control" placeholder="Regd No" name="regd" required=""/>
                    </div>
        ...
        if(isset($_POST['submit1'])) {
            ...
            mysqli_query($link,"INSERT INTO student_reg (firstname, lastname, username, password, email, contact, year, sem, regd, status) 
				  VALUES('$_POST[firstname]', '$_POST[lastname]', '$_POST[username]', '$_POST[password]',
				   '$_POST[email]', '$_POST[contact]', '$_POST[year]','$_POST[sem]', '$_POST[regd]','no');");
