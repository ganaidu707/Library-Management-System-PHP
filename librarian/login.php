    ...
    <section class="login_content">
        <form name="form1" action="" method="post">
            ...
            <div>
                ...
                <a class="reset_pass" href="#">Lost your password??<br>Then Consult Management</a>
            </div>
...
if(isset($_POST['submit1'])){
    $count=0;
    $result=mysqli_query($link, "select * from librarian_reg where username='$_POST[username]' && password='$_POST[password]'");
