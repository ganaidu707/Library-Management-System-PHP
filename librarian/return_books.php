                    ...
                    <div class="x_content">
                        ...
                        <form name="form1" action="" method="post">
                            <table class="table table-bordered">
                                <tr>
                                    <td>
                                        <select name="regd" class="form-control">
                                            <?php
                                            $result=mysqli_query($link,"select student_id from issue_books where book_return_date=''");
                        ...
                        if(isset($_POST["submit"])) {
                            $result = mysqli_query($link, "select * from issue_books where student_id='$_POST[regd]'");
