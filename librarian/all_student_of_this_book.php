            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <?php
                        $result=mysqli_query($link, "select * from issue_books where books_name='$_GET[booksname]' && book_return_date=''");
                        echo "<table class='table table-bordered'>";
                        echo "<tr>";
                        echo "<th>"; echo "student name"; echo"</th>";
                        echo "<th>"; echo "Student Regd ID"; echo"</th>";
                        echo "<th>"; echo "student year"; echo"</th>";
